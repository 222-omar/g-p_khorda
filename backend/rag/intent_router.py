...
GREETING_PATTERNS = [
    r'^(ازيك|إزيك|ازاي|إزاي|عامل ايه|عامل إيه)',
    r'^(اهلا|أهلا|هلا|يا هلا|اهلاً|أهلاً)',
    r'^(سلام|سلام عليكم|السلام عليكم)',
    r'^(هاي|هاى|مرحبا|مرحباً)',
    r'^(hi|hello|hey|good morning|good evening|yo|sup)',
    r'^(صباح الخير|مساء الخير|صباح النور|مساء النور)',
    r'^(كيف حالك|كيف الحال|شو اخبارك)',
]
