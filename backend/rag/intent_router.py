...
GREETING_RESPONSES = [
    "أهلاً بيك! 👋 أنا بوت تدويرة الذكي. قولي بتدور على ايه وأنا هساعدك تلاقيه!",
    "يا هلا! 😊 أنا هنا عشان أساعدك تلاقي أي حاجة بتدور عليها. اسأل براحتك!",
    "أهلاً وسهلاً! 🤖 أنا مساعدك في تدويرة. قولي عايز ايه وأنا هدورلك عليه!",
    "مرحباً! ✨ إزيك! أنا البوت الذكي بتاع تدويرة. اكتبلي اللي بتدور عليه!",
]
...
FAQ_MAP = {
    ...
    r'(انت مين|انتو مين|انتا مين|مين انت|ايه الموقع|ايه التطبيق|بتعمل (ايه|اى|اي)|ايه وظيفتك)':
        "أنا بوت تدويرة الذكي 🤖 بساعدك تلاقي أي حاجة عايز تشتريها أو تبيعها. "
    ...
    r'(ازاي|إزاي).*(المزاد|المزادات|ازايد|أزايد|مزايدة|مزايده)':
        "عشان تزايد:\n"
        "1️⃣ افتح صفحة المنتج المعروض في مزاد\n"
        "2️⃣ اكتب قيمة المزايدة (لازم تكون أكبر من المزايدة الحالية) 🔨\n"
        "3️⃣ اضغط 'زايد الآن' وتتبع المزاد\n"
        "4️⃣ أو فعّل الوكيل الذكي من صفحة 'الوكيل الذكي' عشان يزايد مكانك تلقائياً لحد ميزانيتك!",
}
...
CHITCHAT_PATTERNS = {
    r'^(شكرا|شكراً|متشكر|تسلم|الله ينور|يسلمو|thanks|thank you|thx)': [
        "العفو! 😊 لو محتاج أي حاجة تانية قولي!",
        "ولا يهمك! 🙌 أنا موجود لو محتاج حاجة!",
        "أي خدمة! ✨ بالتوفيق!",
    ],
    r'^(تمام|حلو|جميل|ممتاز|عظيم|رائع|great|nice|cool|ok|أوك|اوك|طيب|ماشي)': [
        "تمام! 😊 لو عايز تدور على حاجة تانية قولي!",
        "حلو! 🎉 أنا هنا لو محتاج أي حاجة!",
    ],
    r'^(باي|مع السلامة|سلام|bye|goodbye|see you|يلا باي)': [
